...
async function request<T>(
  ...
  // Use getAuthSnapshot to read from localStorage if store hasn"t hydrated yet
  // This fixes session persistence on F5/back navigation
  const authStore = getAuthSnapshot();
