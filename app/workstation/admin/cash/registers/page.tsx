...
export default function AdminCashRegistersPage() {
  ...
  return <div className="space-y-6">
    ...
    <div className="grid gap-3 sm:grid-cols-2"><Card size="sm"><CardContent><p className="text-sm text-muted-foreground">Cajas activas</p><p className="mt-1 text-2xl font-semibold">{loading ? <Skeleton className="h-8 w-12" /> : counts.active}</p></CardContent></Card><Card size="sm"><CardContent><p className="text-sm text-muted-foreground">Cajas deshabilitadas</p><p className="mt-1 text-2xl font-semibold">{loading ? <Skeleton className="h-8 w-12" /> : counts.disabled}</p></CardContent></Card></div>
